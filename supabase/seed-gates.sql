WITH seed_gates(
  ...
  VALUES
    ('Pappinisseri', 'Kannur', 11.938737, 75.348391, 'Pappinisseri railway crossing', NULL, NULL, true, 'Locally verified starter gate'),
    ('Muzhappilangad', 'Kannur', 11.799612, 75.448296, 'Muzhappilangad railway crossing', 'Dharmadam', 'DMD', true, 'Locally verified starter gate'),
    ('Thazhe Chovva', 'Kannur', 11.864337, 75.407984, 'Thazhe Chovva railway crossing', 'Kannur South', 'CS', true, 'Locally verified starter gate'),
    ('Melechowa South', 'Kannur', 11.866387, 75.402703, 'Melechowa South railway crossing', 'Kannur South', 'CS', true, 'Locally verified starter gate'),
    ('Pallikkunnu', 'Kannur', 11.888852, 75.360965, 'Pallikkunnu railway crossing', 'Kannur', 'CAN', true, 'Locally verified starter gate'),
    ('Cherukunnu-Keezhara', 'Kannur', 11.990838, 75.308609, 'Cherukunnu-Keezhara railway crossing', 'Kannapuram', 'KPQ', true, 'Locally verified starter gate'),
    ('Thavam', 'Kannur', 12.016511, 75.274600, 'Thavam railway crossing', 'Pazhayangadi', 'PAZ', true, 'Locally verified starter gate'),
    ('Kuyyali (Thalassery)', 'Kannur', 11.759975, 75.488922, 'Kuyyali railway crossing', 'Thalassery', 'TLY', true, 'Locally verified starter gate'),
    ('Gopalpet (New Mahe / Thalassery Border)', 'Kannur', 11.730793, 75.511741, 'Gopalpet railway crossing', 'Mahe', 'MAHE', true, 'Locally verified starter gate'),
    ('Peringadi (Mahe Border)', 'Kannur', 11.710650, 75.544212, 'Peringadi railway crossing', 'Mahe', 'MAHE', true, 'Locally verified starter gate')
)
INSERT INTO gates (
  name,
  district,
